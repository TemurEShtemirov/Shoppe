            ...
            <div className="">
                <main>
                    <section className="section1">
                        <div id="carouselExampleSlidesOnly" className="carousel slide row" data-bs-ride="carousel">
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                    <img src={Banner} className="d-block w-100 ImgCarousel col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6   " alt={Banner} />
                                    <div className="carousel-caption d-none d-md-block col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 Subtitle" style={{
                                        marginTop: '-400px'
                                    }}>
                                ...
                                <div className="carousel-item">
                                    <img src={Banner} width="1248px" height="646px" className="d-block w-100 ImgCarousel col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 " alt={Banner} />
                                    <div className="carousel-caption d-none d-md-block col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 Subtitle mb-" style={{
                                        marginTop: '-400px'
                                    }}>
                                        <p className='title'>Gold big hoops</p>
                                        <p className='price'>$ 68,00</p>
                    ...
                    <div className="row">
                        <div className="row col-lg-6 col-xl-6 col-xxl-6">
                            ...
                            <div className="col-lg-12 col-xl-12 col-xxl-12">
                                <p className='footerTerms'><strong className='strongFooter1'>© 2021 Shelly</strong>. Terms of use <strong className='strongFooter2'>and</strong> privacy policy.</p>
                            </div>
                        </div>
                        <div className='row col-lg-6 col-xl-6 col-xxl-6'>
                            <div className="col-lg-12 col-xl-12 colxxl-12">
                                <a href="" className='AFooterPart2'><p className='FooterPart2'>Give an email, get the newsletter.  <svg className='svg' xmlns="http://www.w3.org/2000/svg" width="25" height="9" viewBox="0 0 25 9" fill="none">
